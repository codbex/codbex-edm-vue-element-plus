...
import { EmployeesRepository, EmployeesEntityOptions } from "../../dao/entities/EmployeesRepository";
...
class EmployeesService {
    ...
    public getAll(_: any, ctx: any) {
        try {
            const options: EmployeesEntityOptions = {
    ...
    public getById(_: any, ctx: any) {
        try {
            ...
            if (entity) {
                ...
                HttpUtils.sendResponseNotFound("Employees not found");
            }
        } catch (error: any) {
            this.handleError(error);
        }
